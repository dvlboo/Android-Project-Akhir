...
//        Buttom Login dengan menghapus spasi
...
//            editor.apply()
        ...
        invalidFieldStream.subscribe { isValid ->
            if (isValid){
                ...
                binding.BLogin.backgroundTintList = ContextCompat.getColorStateList(this,
                    R.color.grey
                )
            }
        }
...
//  membawa parameter data email dan password ke firebase
